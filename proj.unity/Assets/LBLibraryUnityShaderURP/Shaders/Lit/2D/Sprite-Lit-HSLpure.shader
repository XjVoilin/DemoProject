Shader "LIBII/URP/Lit/2D/Sprite-Lit-HSLpure"
{
    Properties
    {
        ...
        _ResultColor("Color",color) = (1,1,1,0)
        ...
        SubShader
        {
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                ...
                float3 rgb = _ResultColor.rgb;
                float3 hsv2 = rgb2hsv(rgb);
                //hsv2.z -= 0.3;
                _ResultColor = float4(hsv2rgb(hsv2), _ResultColor.a);
                //MixInfo info;
                //info.boost = _Boost;
                //info.hue = _Hue;
                ...
                surfaceData.albedo = step(_HSVRange, hsv.z) * (_ResultColor.rgb * _ResultColor.a + (1 - _ResultColor.a)
                    * surfaceData.albedo) + (1 - step(_HSVRange, hsv.z)) * main.rgb * main.a;
        ...
        Pass
        {
            ...
            fout UnlitFragment(Varyings i)
            {
                ...
                mainTex.rgb = step(_HSVRange, hsv.z) * (_ResultColor.rgb * _ResultColor.a + (1 - _ResultColor.a)
                    * mainTex.rgb) + (1 - step(_HSVRange, hsv.z)) * main.rgb * main.a;
