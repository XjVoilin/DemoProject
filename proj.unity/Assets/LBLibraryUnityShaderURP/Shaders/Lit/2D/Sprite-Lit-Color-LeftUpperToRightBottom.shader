Shader "LIBII/URP/Lit/2D/Sprite-Lit-Color-LeftUpperToRightBottom"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                ...
                mixed.rgb = grey;
                mixed.a = main.a;
                // mixed.rgb = adjustColorLT2RB(mixed.rgba, i.uv * float2(_UV2.z+_UV22.z,_UV2.w+_UV22.w) + _UV2.xy+_UV22.xy).rgb;
                mixed.rgb = adjustColorLT2RB(mixed.rgba, i.uv8 * float2(_Slope, _Width) + float2(0, _Offset)).rgb;
        ...
        Pass
        {
            ...
            fout UnlitFragment(Varyings i)
            {
                ...
                mainTex.rgb = step(_HSVRange, hsvOri.z) * mixed.rgb + (1 - step(_HSVRange, hsvOri.z)) * mainTex.rgb;
