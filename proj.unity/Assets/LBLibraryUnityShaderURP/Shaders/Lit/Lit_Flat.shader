...
Shader "LIBII/URP/Lit/LitFlat"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment LitPassFragmentFlat
            ...
            #include "../../ShaderLibrary/Inputs/LibiiInput.hlsl"
            #include "../../ShaderLibrary/Passes/LibiiLitForwardPass.hlsl"
            ENDHLSL
        }
