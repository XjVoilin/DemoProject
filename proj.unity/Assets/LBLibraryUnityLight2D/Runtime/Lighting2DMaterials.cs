...
namespace LIBII.Light2D
{
	...
	public class Lighting2DMaterials
	{
		...
		public Material GetLightSprite()
		{
			...
			{
				lightSprite = LightingMaterial.Load("LIBII/Light2D/Internal/LightSprite/Light");
			}
		...
		public Material GetMaskBlurVertical()
		{
			...
			{
				maskBlurVertical = LightingMaterial.Load("LIBII/Light2D/Internal/BlurVertical");
			}
		...
		public Material GetMaskBlurHorizontal()
		{
			...
			{
				maskBlurHorizontal = LightingMaterial.Load("LIBII/Light2D/Internal/BlurHorizontal");
			}
		...
		public Material GetAdditive()
		{
			...
			{
				additive = LightingMaterial.Load("LIBII/Light2D/Internal/Additive");
			}
		...
		public Material GetMultiplyHDR()
		{
			...
			{
				multiplyHDR = LightingMaterial.Load("LIBII/Light2D/Internal/Multiply HDR");
			}
		...
		public Material GetAlphaColor()
		{
			...
			{
				alphablend = LightingMaterial.Load("LIBII/Light2D/Internal/AlphaColor");
			}
		...
		public Material GetOcclusionEdge()
		{
			...
			{
				occlusionEdge = LightingMaterial.Load("LIBII/Light2D/Internal/Multiply HDR");
		...
		public Material GetOcclusionBlur()
		{
			...
			{
				occlusionBlur = LightingMaterial.Load("LIBII/Light2D/Internal/Multiply HDR");
