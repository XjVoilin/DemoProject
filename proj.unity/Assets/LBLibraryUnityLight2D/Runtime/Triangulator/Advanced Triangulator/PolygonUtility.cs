...
namespace LIBII.Light2D
{
    public class PolygonUtil
    {
            ...
            for (int curVertex = 0; curVertex < poly.Count; curVertex++)
            {
                ...
                if (bCurVertexIsToRight)
                {
                    ...
                    else
                    {
                        ...
                        bool bIntersect = TriangulationUtil.RaysIntersect2D(poly[lastVertex], tempRay, edgeBegin,
        ...
        public static PolygonUtil.PolyUnionError PolygonUnion(Point2DList polygon1, Point2DList polygon2,
        ...
        public static PolygonUtil.PolyUnionError PolygonIntersect(Point2DList polygon1, Point2DList polygon2,
        ...
        public static PolygonUtil.PolyUnionError PolygonSubtract(Point2DList polygon1, Point2DList polygon2,
        ...
        public static PolygonUtil.PolyUnionError PolygonOperation(PolygonUtil.PolyOperation operations,
            Point2DList polygon1, Point2DList polygon2, out Dictionary<uint, Point2DList> results)
        {
            PolygonOperationContext ctx = new PolygonOperationContext();
    ...
    public class Contour : Point2DList, ITriangulatable, IEnumerable<TriangulationPoint>, IList<TriangulationPoint>
    {
        ...
        public override void AddRange(IEnumerator<Point2D> iter, WindingOrderType windingOrder)
        {
            ...
            bool bReverseReadOrder = (WindingOrder != WindingOrderType.Unknown) &&
        ...
        public static void InitializeHoles(List<Contour> holes, ITriangulatable parent, ConstrainedPointSet cps)
        {
            ...
            while (holeIdx < numHoles)
            {
                ...
                while (hole2Idx < numHoles)
                {
                    ...
                    {
                        bool bIntersect = PolygonUtil.PolygonsIntersect2D(holes[holeIdx], holes[holeIdx].Bounds,
