...
namespace LIBII.Light2D
{
    public class Polygon2
    {
        ...
        public float[] strengthes;
        public Polygon2[] holes;
        ...
        public Polygon2 Copy()
        {
            ...
            float[] strens = new float[points.Length];

            System.Array.Copy(points, array, points.Length);
            System.Array.Copy(strengthes, strens, points.Length);
        ...
        {
            return (PolygonTriangulator2.Triangulate(this, UVScale, UVOffset, triangulation, keepHoleTriangles));
        }
