...
namespace LIBII.Light2D
{
    public class Polygon2D
    {
            ...
            PolygonTriangulator2D.Triangulation triangulation = PolygonTriangulator2D.Triangulation.Advanced)
        {
            ...
            Rect uvRect = new Rect((float) spriteRect.x / texture.width, (float) spriteRect.y / texture.height,
                (float) spriteRect.width / texture.width, (float) spriteRect.height / texture.height);

            Vector2 scale = new Vector2(spriteSheetU * spriteRect.width / sprite.pixelsPerUnit,
