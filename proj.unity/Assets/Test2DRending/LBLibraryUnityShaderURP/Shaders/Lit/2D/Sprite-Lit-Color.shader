Shader "LIBII/URP/Lit/2D/Sprite-Lit-Color"
{
    Properties
    {
        ...
        _C1 ("C1 Color", Color) = (0,0,0,0)
        _C2 ("C2 Color", Color) = (0,0,0,0)
        _C3 ("C3 Color", Color) = (0,0,0,0)
        _C4 ("C4 Color", Color) = (0,0,0,0)
        _C5 ("C5 Color", Color) = (0,0,0,0)
        _C6 ("C6 Color", Color) = (0,0,0,0)
        ...
        Pass
        {
            ...
            fout UnlitFragment(Varyings i)
            {
                ...
                float4 mixed = sampleGradientColor(_C1, _C2, _C3, _C4, _C5, _C6,
                                                   _P1, _P2, _P3, _P4, _P5, _P6, _ColorCount,
                                                   rotateUV(i.uv, adjustedAngle).y);
                mainTex.rgb = mixed.rgb * mixed.a + (1 - mixed.a) * mainTex.rgb;
