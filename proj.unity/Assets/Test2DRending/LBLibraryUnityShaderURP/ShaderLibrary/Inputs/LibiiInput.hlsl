#ifndef UNIVERSAL_PIPELINE_LIBII_INPUT_INCLUDED
#define UNIVERSAL_PIPELINE_LIBII_INPUT_INCLUDED
...
inline void InitializeStandardLitSurfaceDataNoRepeat(float2 uv, out SurfaceData outSurfaceData, float4 normal_ST)
{
    ZERO_INITIALIZE(SurfaceData, outSurfaceData);

    half4 albedoAlpha = SampleTextureNoRepeatTech2(uv, TEXTURE2D_ARGS(_BaseMap, sampler_BaseMap));
